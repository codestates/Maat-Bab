        ...
        <div className='mapsearch__background'>
            <div className='modal__search__content__container'>
                ...
                <div className='modal__search__region__conatiner'>
                    ...
                    <button onClick={changeplace} className='main__select__region__search'><FontAwesomeIcon className= 'search__icon' width='20' height='20' viewBox= "0 128 256 256" color='orange' icon={faSearchLocation} /></button>
                    </span>
                </div>
