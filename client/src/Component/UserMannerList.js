    ...
    return (
            <div className='userMannerList'>
                ...
                {mannerList?.map((manner, index) => manner.selected === true  ?
                    <li key={index} className='manner selected' onClick={() => selectManner(manner.manner_id)} >{manner.text}</li>
                    :
                    <li key={index} className='manner' onClick={() => selectManner(manner.manner_id)} >{manner.text}</li>
                    )}
            </ul>
